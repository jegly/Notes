...
import com.kin.easynotes.di.ApplicationModule_ProvideBackupRepositoryFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    ImportExportUseCase importExportUseCase() {
      return new ImportExportUseCase(singletonCImpl.provideNoteRepositoryProvider.get(), singletonCImpl.provideCoroutineScopeProvider.get(), singletonCImpl.provideBackupRepositoryProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new SettingsViewModel(viewModelCImpl.galleryObserver(), singletonCImpl.provideBackupRepositoryProvider.get(), viewModelCImpl.settingsUseCase(), singletonCImpl.noteUseCase(), viewModelCImpl.importExportUseCase(), singletonCImpl.provideEncryptionHelperProvider.get());
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    Provider<ImportExportRepository> provideBackupRepositoryProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideSettingsRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<SettingsRepositoryImpl>(singletonCImpl, 4));
      this.provideExecutorCoroutineDispatcherProvider = DoubleCheck.provider(new SwitchingProvider<ExecutorCoroutineDispatcher>(singletonCImpl, 6));
      this.provideBackupRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<ImportExportRepository>(singletonCImpl, 5));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) ApplicationModule_ProvideEncryptionHelperFactory.provideEncryptionHelper();

          case 4: // com.kin.easynotes.data.repository.SettingsRepositoryImpl
          ...
          case 5: // com.kin.easynotes.data.repository.ImportExportRepository
          return (T) ApplicationModule_ProvideBackupRepositoryFactory.provideBackupRepository(singletonCImpl.provideNoteDatabaseProvider.get(), ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule), ApplicationModule_ProvideMutexFactory.provideMutex(), singletonCImpl.provideCoroutineScopeProvider.get(), singletonCImpl.provideExecutorCoroutineDispatcherProvider.get());

          case 6: // kotlinx.coroutines.ExecutorCoroutineDispatcher
